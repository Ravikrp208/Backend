...
export const listFiles = tool(
  async ({}) => {
    ...
    const response = await axios.get(
      "http://019e2739-bc90-7502-aafc-23850483cdbe.agent.localhost/list-files",
    );
...
export const readFiles = tool(
  async ({ files: [] }) => {
    ...
    const response = await axios.get(
      "http://019e2739-bc90-7502-aafc-23850483cdbe.agent.localhost/read-files?files=" +
        files.join(","),
    );
...
export const updateFiles = tool(
  async ({ files }) => {
    ...
    const response = await axios.patch(
      "http://019e2739-bc90-7502-aafc-23850483cdbe.agent.localhost/update-files",
      {
        updates: files,
      },
    );

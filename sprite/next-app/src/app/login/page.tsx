...
export default function Login() {
  return (
    <div className="min-h-screen bg-[var(--color-sprite-dark)] text-white flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-[#00ffcc]/10 blur-[120px] rounded-full pointer-events-none animate-float" />
      <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-[#00ff00]/10 blur-[120px] rounded-full pointer-events-none animate-float" style={{ animationDelay: '3s' }} />
      ...
      <div className="w-full max-w-md glass-panel p-10 rounded-3xl relative z-10 animate-fade-in-up">
        ...
        <h1 className="text-4xl font-extrabold uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-white to-[#00ff00] mb-2 text-center text-glow">Welcome Back</h1>
        <p className="text-center text-gray-400 font-light mb-10 tracking-widest text-xs uppercase">Sign in to your refreshing account.</p>
        ...
        <form className="space-y-6">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            <div className="flex justify-between items-center mb-2 pl-1">
              <label className="block text-[10px] font-bold tracking-[0.2em] uppercase text-gray-400">Password</label>
              <Link href="#" className="text-[10px] text-[var(--color-sprite-green)] hover:text-white transition-colors uppercase tracking-widest">Forgot?</Link>
            </div>
            <input 
              type="password" 
              className="w-full px-5 py-4 bg-black/40 border border-white/10 rounded-xl focus:outline-none focus:border-[var(--color-sprite-green)] text-white placeholder-gray-600 transition-all duration-300 input-glow" 
          ...
          <div className="pt-4 animate-fade-in-up" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
            <button 
              type="button" 
            ...
            >
              <span className="relative z-10 transition-transform duration-300 group-hover:scale-105 inline-block">SIGN IN</span>
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </button>
          </div>
        </form>
        
        <p className="mt-8 text-center text-xs tracking-wider text-gray-500 animate-fade-in-up" style={{ animationDelay: '0.4s', animationFillMode: 'both' }}>
          NEW HERE? <Link href="/register" className="text-white hover:text-[var(--color-sprite-green)] hover:underline transition-colors font-semibold">CREATE ACCOUNT</Link>
        </p>
      </div>
